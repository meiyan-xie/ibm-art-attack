...
class modelWrapper():
    ...
    def predict_one_hot(self, x_test):
        ...
        pred_y = self.model.predict(x_test, cuda=True)
...
def main():
    ...
    modelpath = '../binary/checkpoints/cifar10_simclr_scd01mlp_32_br02_h20_nr075_ni1000_i1_0.pkl'
    ...
    # Predict
    pred_y = model.predict(x_test, cuda=True).astype(int)
    ...
    print('adv_data predict: ', model.predict(adv_data, cuda=True))
